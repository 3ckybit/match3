...
//Класс Game управляет игровым полем, отслеживая все Tile на доске и обрабатывая логику замены плиток и проверки совпадений. Класс Game также управляет таймером игры и обновляет счет.
//Когда игра заканчивается, он переключается на GameOver экран.
